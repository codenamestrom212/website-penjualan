		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> 085974887814</span>
				</div>
				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> twentythreejeans@gmail.com</span>
				</div>
				<div class="col-md-4"  style="padding: 3px;">
					<span>Twenty Three Jeans Indonesia</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #76a4cf; font-size: 28px;"><b>Twenty Three Jeans</b></a>
			</div>
